...
public class Store
    {
        ...
        {
            Items.Add(new Item($"{ "수련자 갑옷", -10 }", ItemType.Armor, 5, $"{ "수련에 도움을 주는 갑옷입니다.", -30 }", 1000));
            Items.Add(new Item($"{ "무쇠 갑옷", -10 }", ItemType.Armor, 9, $"{ "무쇠로 만들어져 튼튼한 갑옷입니다.", -30 }", 2200));
            Items.Add(new Item($"{ "스파르타 갑옷", -10 }", ItemType.Armor, 15, $"{ "스파르타의 전사들이 사용했다는 전설의 갑옷입니다.", -30 }", 3500));
